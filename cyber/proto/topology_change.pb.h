...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_topology_5fchange_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace proto {
class ChangeMsg;
...
class ChangeMsg PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_topology_5fchange_2eproto_metadata_getter(kIndexInFileMessages);
  }
