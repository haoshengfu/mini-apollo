...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_unit_5ftest_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace proto {
class Chatter;
...
class UnitTest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_unit_5ftest_2eproto_metadata_getter(kIndexInFileMessages);
  }
