...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_5fdesc_2eproto = {
  false, false, 118, descriptor_table_protodef_proto_5fdesc_2eproto, "proto_desc.proto", 
  &descriptor_table_proto_5fdesc_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_proto_5fdesc_2eproto::offsets,
  file_level_metadata_proto_5fdesc_2eproto, file_level_enum_descriptors_proto_5fdesc_2eproto, file_level_service_descriptors_proto_5fdesc_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_proto_5fdesc_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_proto_5fdesc_2eproto);
  return descriptor_table_proto_5fdesc_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_proto_5fdesc_2eproto(&descriptor_table_proto_5fdesc_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
