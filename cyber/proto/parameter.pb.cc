...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_parameter_2eproto = {
  false, false, 470, descriptor_table_protodef_parameter_2eproto, "parameter.proto", 
  &descriptor_table_parameter_2eproto_once, nullptr, 0, 5,
...
descriptor_table_parameter_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_parameter_2eproto);
  return descriptor_table_parameter_2eproto.file_level_metadata[index];
}
