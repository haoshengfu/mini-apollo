...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_choreography_5fconf_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace proto {
...
class InnerThread PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_choreography_5fconf_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
// repeated .apollo.cyber.proto.InnerThread threads = 12;
inline int ChoreographyConf::_internal_threads_size() const {
  return threads_.size();
}
inline int ChoreographyConf::threads_size() const {
  return _internal_threads_size();
}
inline void ChoreographyConf::clear_threads() {
  threads_.Clear();
}
inline ::apollo::cyber::proto::InnerThread* ChoreographyConf::mutable_threads(int index) {
  // @@protoc_insertion_point(field_mutable:apollo.cyber.proto.ChoreographyConf.threads)
  return threads_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::cyber::proto::InnerThread >*
ChoreographyConf::mutable_threads() {
  // @@protoc_insertion_point(field_mutable_list:apollo.cyber.proto.ChoreographyConf.threads)
  return &threads_;
}
inline const ::apollo::cyber::proto::InnerThread& ChoreographyConf::_internal_threads(int index) const {
  return threads_.Get(index);
}
inline const ::apollo::cyber::proto::InnerThread& ChoreographyConf::threads(int index) const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ChoreographyConf.threads)
  return _internal_threads(index);
}
inline ::apollo::cyber::proto::InnerThread* ChoreographyConf::_internal_add_threads() {
  return threads_.Add();
}
inline ::apollo::cyber::proto::InnerThread* ChoreographyConf::add_threads() {
  // @@protoc_insertion_point(field_add:apollo.cyber.proto.ChoreographyConf.threads)
  return _internal_add_threads();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::cyber::proto::InnerThread >&
ChoreographyConf::threads() const {
  // @@protoc_insertion_point(field_list:apollo.cyber.proto.ChoreographyConf.threads)
  return threads_;
}
