...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_topology_5fchange_2eproto = {
  false, false, 567, descriptor_table_protodef_topology_5fchange_2eproto, "topology_change.proto", 
  &descriptor_table_topology_5fchange_2eproto_once, descriptor_table_topology_5fchange_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_topology_5fchange_2eproto::offsets,
  file_level_metadata_topology_5fchange_2eproto, file_level_enum_descriptors_topology_5fchange_2eproto, file_level_service_descriptors_topology_5fchange_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_topology_5fchange_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_topology_5fchange_2eproto);
  return descriptor_table_topology_5fchange_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_topology_5fchange_2eproto(&descriptor_table_topology_5fchange_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
