...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_component_5fconf_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace proto {
...
class ReaderOption PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_component_5fconf_2eproto_metadata_getter(kIndexInFileMessages);
  }
