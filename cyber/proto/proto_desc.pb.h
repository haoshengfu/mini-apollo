...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_proto_5fdesc_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace proto {
class ProtoDesc;
...
class ProtoDesc PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_proto_5fdesc_2eproto_metadata_getter(kIndexInFileMessages);
  }
