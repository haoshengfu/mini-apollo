...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_qos_5fprofile_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace proto {
class QosProfile;
...
class QosProfile PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_qos_5fprofile_2eproto_metadata_getter(kIndexInFileMessages);
  }
