...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_role_5fattributes_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace proto {
...
class SocketAddr PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_role_5fattributes_2eproto_metadata_getter(kIndexInFileMessages);
  }
