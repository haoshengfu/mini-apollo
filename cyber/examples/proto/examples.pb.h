...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_examples_2eproto_metadata_getter(int index);
namespace apollo {
namespace cyber {
namespace examples {
namespace proto {
...
class SamplesTest1 PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_examples_2eproto_metadata_getter(kIndexInFileMessages);
  }
