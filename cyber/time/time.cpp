...
std::string Time::ToString() const {
  ...
  std::chrono::time_point<std::chrono::system_clock, std::chrono::nanoseconds> tp(nano);
  
  auto time = std::chrono::system_clock::to_time_t(std::chrono::time_point_cast<std::chrono::seconds>(tp));
